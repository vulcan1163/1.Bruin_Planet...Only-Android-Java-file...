	...
	VideoView videoView;
	 ...
	 @Override
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        h.postDelayed(mrun, 11500); // 딜레이 ( 런어블 객체는 mrun, 시간 2초)
	        
	        
	       videoView = (VideoView)findViewById(R.id.videos);

	       Uri video = Uri.parse("android.resource://com.example.mb_0417_test/"+ R.raw.project_4);
	    ...
	    Runnable mrun = new Runnable(){
	        @Override
	        public void run(){
	        Intent i = new Intent(SecLoading.this, Manu.class); //인텐트 생성(현 액티비티, 새로 실행할 액티비티)
